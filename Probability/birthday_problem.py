#@autor codecademy
#This code solve the birthday problem “What is the probability that two people in a room have the same birthday?” 
#the probability is dependent on the number of people in the room.
